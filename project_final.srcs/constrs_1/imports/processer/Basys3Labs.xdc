...
## LEDs
#set_property PACKAGE_PIN U16 [get_ports {Q7_out[0]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {Q7_out[0]}]
#set_property PACKAGE_PIN E19 [get_ports {Q7_out[1]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {Q7_out[1]}]
#set_property PACKAGE_PIN U19 [get_ports {Q7_out[2]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {Q7_out[2]}]
#set_property PACKAGE_PIN V19 [get_ports {Q7_out[3]}]
#	set_property IOSTANDARD LVCMOS33 [get_ports {Q7_out[3]}]
...
set_property PACKAGE_PIN P1 [get_ports {ZF}]
